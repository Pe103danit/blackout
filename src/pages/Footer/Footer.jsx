                    ...
                    <div className={`${style.footer__content}`}>
                            ...
                            <div className={`${style.footer__item} ${footerItemInnerLinkList}`}>
                                ...
                                <ul className={`${style.footer__linklist}`}>
                                    <li className={`${style.footer__linklist_item}`}>
                                        <NavLink to={'/'} className={`${style.footer__linklist_item_link}`}>Portable Power Stations</NavLink>
                                    </li>
                                    <li className={`${style.footer__linklist_item}`}>
                                        <NavLink to={'/'} className={`${style.footer__linklist_item_link}`}>Power Banks</NavLink>
                                    </li>
                                    <li className={`${style.footer__linklist_item}`}>
                                        <NavLink to={'/'} className={`${style.footer__linklist_item_link}`}>Generators</NavLink>
                                    </li>
                                    <li className={`${style.footer__linklist_item}`}>
                                        <NavLink to={'/'} className={`${style.footer__linklist_item_link}`}>Solar Panels</NavLink>
                                    </li>
                                    <li className={`${style.footer__linklist_item}`}>
                                        <NavLink to={'/'} className={`${style.footer__linklist_item_link}`}>Accessories</NavLink>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className={`${style.footer__item} ${footerItemLinkList}`}>
                            <div className={`${style.footer__item} ${footerItemInnerLinkList}`}>
                                ...
                                <ul className={`${style.footer__linklist}`}>
                                    <li className={`${style.footer__linklist_item}`}>
                                        <NavLink to={'/payment'} className={`${style.footer__linklist_item_link}`}>Payment Policy</NavLink>
                                    </li>
                                    <li className={`${style.footer__linklist_item}`}>
