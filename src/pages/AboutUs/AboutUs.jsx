    ...
    return (
        <div className={`${style.aboutUs} ${themeStyle}`}>
            ...
            <div className={style.aboutUs_imgContainer}>
                ...
                <p>POWER A NEW WORLD</p>
            </div>
            <div className={style.aboutUs_info}>
                <h1>About Black Out Store</h1>
                <ul className={style.aboutUs_info_ul}>
                    <li className={style.aboutUs_info_ul_li}>
                        <span>Welcome to Black Out Store, your premier destination for all things power-related. Founded in 2023 by a passionate group of innovators in the heart of Kyiv, Ukraine, our mission is to bring electricity and power to every corner of the world, starting with our home country, Ukraine.</span>
                        <span>At Black Out Store, we believe in the transformative power of energy. We understand that access to reliable electricity is not just a convenience but a fundamental necessity for modern life. That's why we've dedicated ourselves to providing a wide range of cutting-edge solutions, from alarm power stations to power banks and solar panels.</span>
                        <span>While we serve customers around the world, our heart and focus remain on Ukraine. We are proud to contribute to the ongoing effort to power up Ukraine and improve the lives of its citizens. By choosing Black Out Store, you're not just purchasing a product; you're investing in a brighter, more sustainable future for all.</span>
                        <span>Join us on this electrifying journey as we continue to innovate and expand our product offerings. At Black Out Store, we are dedicated to powering your life, wherever you are.</span>
            ...
            <div className={style.aboutUs_info}>
                ...
                <ul className={style.aboutUs_info_ul}>
                    <li className={style.aboutUs_info_ul_li}>
                        ...
                        <span>Discover the future of power with Black Out Store. Together, we'll light up the world, one innovation at a time.</span>
                    </li>
                </ul>
            </div>
        </div>
